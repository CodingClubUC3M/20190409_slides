...
#### Blue color for UC3m net  ..........   Red color for Others nets
...
```{r}
filtro<-LogFile[LogFile$WeekDay=="Mo",]

# Use the function on the created data
barplot(t(table(filtro$Hour, filtro$Net)),col=c("Blue","Red"))
```
...
```{r}
filtro<-LogFile[LogFile$WeekDay=="Th",]
...
```{r}
filtro<-LogFile[LogFile$WeekDay=="Tu",]
...
```{r}
filtro<-LogFile[LogFile$WeekDay=="Fr",]
...
```{r}
filtro<-LogFile[LogFile$WeekDay=="We",]
...
```{r}
filtro<-LogFile[LogFile$WeekDay=="Sa"|LogFile$WeekDay=="Su",]
